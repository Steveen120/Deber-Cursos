...
(function (Course) {
    ...
    Course["BaseDatos"] = "Base de Datos avanzada";
    Course["Metodologia"] = "Metodologia de Desarrollo de Software";
})(Course || (Course = {}));
var Area;
(function (Area) {
    Area["Desarrollo"] = "Desarrollo de Software";
    Area["Bomberos"] = "Bomberos";
    Area["ArteCulinario"] = "Arte Culinario";
})(Area || (Area = {}));
function addStudent() {
    let currentStudent = {
